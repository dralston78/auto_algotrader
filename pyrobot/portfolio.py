...
class Portfolio():
    ...
    def add_position(self, symbol: str, asset_type: str, purcahse_date: Optional[str], quantity: int = 0, purchase_price: float=0.0, ):
        
        self.positions[symbol] = {}
        self.positions[symbol]['symbol'] = symbol
        self.positions[symbol]['quantity'] = quantity
        self.positions[symbol]['purchase_price '] = purchase_price
        self.positions[symbol]['purchase_date'] = purcahse_date
        ...
        if isinstance(positions, List):
            for position in positions:
                self.add_position(
                    ...
                    purcahse_date=position.get('purchase_date', None),
    ...
    def remove_position(self, symbol: str) -> Tuple[bool,str]:
        ...
        if symbol in self.positions:
            ...
            return (True, "{0} was successfully removed".format(symbol))
        else:
            return (False, "{0} did not exist in portfolio".format(symbol))
